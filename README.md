...
**DDLG (daddy-dom, little-girl) — это тематическая модель доминант-сабмиссив отношений из "семейства" CGL\***. Может быть как в лайф-стайл, так и в сессионной форме. Главное в таких отношениях — чётко обозначенные роли Заботодарителя (Папочка, Папа) и Малыша (возможны любые прозвища, в т.ч. отсутствие такового).
...
* **Чёткое определение ролей:** В отношениях DDLG важно, чтобы каждый участник понимал свою роль (Папочка/Заботодаритель или Малыш) и соответствующие обязанности.
